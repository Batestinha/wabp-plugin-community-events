...
export const eventsMessages: MessageCatalog = {
  ...
  'official.community-events.profile.climbing.weather.template': 'Weather for {groupDisplayName} on {weatherDate}: {weatherSummary}',
  ...
  'official.community-events.weather.metric.windSpeed': 'Wind speed',
  'official.community-events.weather.metric.windGust': 'Wind gust',
  'official.community-events.weather.metric.windDirection': 'Wind direction',
