...
export const eventsMessages: MessageCatalog = {
  ...
  'official.community-events.update.privateStartFailed': 'I could not send the private event update message. Start a private chat with me and try /title again.',
  ...
  'official.community-events.update.confirmPastCompletion': 'Update this event to a past date?\n\n{summary}\n\nConfirming will complete the event and immediately start managed subgroup cleanup. Cleanup removes participants, unlinks the subgroup, and makes the bot leave it.',
  ...
  'official.community-events.update.ambiguous': 'More than one event record owns this subgroup in the current scope. Resolve the duplicate records in the operator console before using /title.',
  'official.community-events.update.pastCompletionConfirmationRequired': 'The event date is now in the past. Start /title again so the completion and subgroup cleanup warning can be confirmed.',
  ...
  'official.community-events.update.donePastCompletion': 'Event updated: {title} ({eventId}). Completion and subgroup cleanup were queued.',
  'official.community-events.update.donePastCompletionRepairPending': 'Event data updated: {title} ({eventId}), and subgroup cleanup was queued. The live title or calendar did not fully synchronize; check the operator logs.',
  'official.community-events.update.failed': 'Could not update the event: {reason}',
